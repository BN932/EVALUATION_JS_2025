export default function(contact){          
        ...
        return `
            ...
            <tr class="contact-row" data-id="${contact.id}">
              <td class="p-4">
                <span class="label-firstname isEditing-hidden">${contact.firstname}</span>
                <input
                  type="text"
              ...
              <td class="p-4">
                <span class="label-lastname isEditing-hidden">${contact.lastname}</span>
                <input
                  type="text"
              ...
              <td class="p-4">
                <span class="label-email isEditing-hidden">${contact.email}</span>
                <input
                  type="text"
